...
<div class="container-fluid">
		...
		<div class="col-sm-6">
			...
			<!-- Articles -->
			<div class="row">
                            <h2>Connsulta de media de Estudiantes</h2>	
                                <!-- Form --> 
                            <div class="panel panel-default">
                                    <div class="panel-heading">
                                            <h3 class="panel-title">
                                    ...
                                    <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                            <input type="text" class="form-control" id="uid" name="cedula" placeholder="Nombre Escuela">
                                                    </div>
                                                   
                                                   
                                                         
                                                    <button type="submit" name="Boton1" class="btn btn-default">Consultar</button>
              ...
              <tbody>
                <%
                    if(request.getAttribute("lista")!=null){
                        ArrayList estudiantes = (ArrayList<Estudiante>)request.getAttribute("lista");
                        for (int i = 0; i < estudiantes.size(); i++) {
                            Estudiante persona = (Estudiante)estudiantes.get(i);
                    %>
                      <tr>
                        <td><%=persona.getCodEst()%></td>
                        <td><%=persona.getNombre()%></td>
                        <td><%=persona.getCodEscu()%></td>
                        <td><%=persona.getBeca()%></td>
                        <td><a href="RegistroServlet?editar=<%=persona.getCodEst()%>">Editar</a></td>
                        <td><a href="RegistroServlet?borrar=<%=persona.getCodEst()%>">Borrar</a></td>
                     </tr>
                    <%
                        }
                    }
